...
// 
//
// Related Topics 树 深度优先搜索 广度优先搜索 二叉树 👍 1396 👎 0
...
public class MergeTwoBinaryTrees {
    ...
    class Solution {
        public TreeNode mergeTrees1(TreeNode root1, TreeNode root2) {
            ...
            if (root1 == null) {
                res.val = root2.val;
                res.left = mergeTrees1(null, root2.left);
                res.right = mergeTrees1(null, root2.right);
            } else if (root2 == null) {
                res.val = root1.val;
                res.left = mergeTrees1(root1.left, null);
                res.right = mergeTrees1(root1.right, null);
            } else {
